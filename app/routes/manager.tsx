...
import { LayoutDashboard, Users, ClipboardList, ChevronLeft } from "lucide-react";
import { BrandMark } from "~/megma/components/brand";
import { cn } from "~/lib/utils";

const NAV = [
  { to: "/manager", label: "Dashboard", icon: LayoutDashboard, end: true },
  { to: "/manager/reps", label: "Rep Performance", icon: Users, end: false },
  { to: "/manager/visits", label: "Call Activity", icon: ClipboardList, end: false },
];
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="hidden w-60 shrink-0 flex-col bg-sidebar text-sidebar-foreground md:flex">
        <div className="border-b border-sidebar-border px-5 py-4">
          ...
          <p className="mt-1 text-xs text-sidebar-foreground/70">Manager Console</p>
        </div>
